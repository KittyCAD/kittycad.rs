...
impl Users {
    ...
    pub fn get_user_self(&self) -> Result<()> {
        Ok(())
    }
    ...
    pub fn update_user_self(&self) -> Result<()> {
        Ok(())
    }
    ...
    pub fn get_user_self_extended(&self) -> Result<()> {
        Ok(())
    }
    ...
    pub fn list_extended(&self) -> Result<()> {
        Ok(())
    }
    ...
    pub fn get_user_extended(&self) -> Result<()> {
        Ok(())
    }
