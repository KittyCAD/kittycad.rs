...
impl Payments {
    ...
    #[doc = "Create payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It creates the payment information for the authenticated user.\n\n```\nasync fn example_payments_create_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .create_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"h\".to_string()),\n                country: Some(\"shtgrwvx\".to_string()),\n                created_at: chrono::DateTime::<chrono::Utc>::parse_from_rfc3339(\n                    \"1960-11-12T21:08:25.663+00:00\",\n                )?,\n                id: uuid::Uuid::from_str(\"d8125f5d-10c6-47d9-9c21-ee1efdbaef23\")?,\n                state: Some(\"ujd\".to_string()),\n                street_1: Some(\"roaluqr\".to_string()),\n                street_2: Some(\"cn\".to_string()),\n                updated_at: chrono::DateTime::<chrono::Utc>::parse_from_rfc3339(\n                    \"2023-01-10T20:04:55.532+00:00\",\n                )?,\n                user_id: Some(\"gtkv\".to_string()),\n                zip: Some(\"viudl\".to_string()),\n            }),\n            name: Some(\"c\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 655-107-2643\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n\n```"]
