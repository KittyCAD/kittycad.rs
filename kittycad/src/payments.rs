...
impl Payments {
    ...
    #[doc = "Update payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It updates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_update_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .update_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"flioth\".to_string()),\n                country: Some(\"wryot\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"08bd4d91-a8ec-4e0e-9aaf-f9f73e9d11c9\")?,\n                state: Some(\"svysgk\".to_string()),\n                street_1: Some(\"nrvuyuev\".to_string()),\n                street_2: Some(\"lbqghske\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"ryhgndkdo\".to_string()),\n                zip: Some(\"\".to_string()),\n            }),\n            name: Some(\"xykpd\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 0688427522\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    ...
    #[doc = "Create payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It creates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_create_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .create_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"rnfcsln\".to_string()),\n                country: Some(\"esnknypj\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"d2c5ae9a-5573-4e3b-b8f6-0be758994df8\")?,\n                state: Some(\"unykl\".to_string()),\n                street_1: Some(\"xcypgywxt\".to_string()),\n                street_2: Some(\"laepxyv\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"ivkglm\".to_string()),\n                zip: Some(\"wludrg\".to_string()),\n            }),\n            name: Some(\"rejd\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 1757365257\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
