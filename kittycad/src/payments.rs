...
impl Payments {
    ...
    #[doc = "Update payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It updates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_update_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .update_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"worq\".to_string()),\n                country: Some(\"jquo\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"76352c9f-16eb-4ebc-9634-e25e8c344361\")?,\n                state: Some(\"njlgqp\".to_string()),\n                street_1: Some(\"wiid\".to_string()),\n                street_2: Some(\"hfoqxrpj\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"d\".to_string()),\n                zip: Some(\"onrcdlq\".to_string()),\n            }),\n            name: Some(\"tny\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 855-418-1280\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    ...
    #[doc = "Create payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It creates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_create_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .create_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"\".to_string()),\n                country: Some(\"jhgwchs\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"476f0d50-5ba3-49ff-920f-5e0e9326bd28\")?,\n                state: Some(\"khay\".to_string()),\n                street_1: Some(\"lfglm\".to_string()),\n                street_2: Some(\"j\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"jyqmlt\".to_string()),\n                zip: Some(\"trh\".to_string()),\n            }),\n            name: Some(\"mrftiokk\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 372-688-2522\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
