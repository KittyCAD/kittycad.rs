...
impl Payments {
    ...
    #[doc = "Create payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It creates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_create_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .create_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"pfcubapfg\".to_string()),\n                country: Some(\"qqkaerb\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"84fc77e5-f8ef-4055-b6c6-72f23f66f46b\")?,\n                state: Some(\"lws\".to_string()),\n                street_1: Some(\"couh\".to_string()),\n                street_2: Some(\"cioh\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"bmlj\".to_string()),\n                zip: Some(\"ifaihkm\".to_string()),\n            }),\n            name: Some(\"\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 731-820-7541\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
