...
impl Payments {
    ...
    #[doc = "Update payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It updates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_update_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .update_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"w\".to_string()),\n                country: Some(\"airup\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"353ec0a4-cb71-45f4-aa8c-9890d5ba2714\")?,\n                state: Some(\"bddjohgo\".to_string()),\n                street_1: Some(\"pxcotas\".to_string()),\n                street_2: Some(\"\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"quuctqrr\".to_string()),\n                zip: Some(\"ww\".to_string()),\n            }),\n            name: Some(\"duraq\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 653-055-2686\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n\n```"]
    ...
    #[doc = "Create payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It creates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_create_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .create_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"jpyubv\".to_string()),\n                country: Some(\"\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"ea51f63d-6452-4781-89f3-e382f98e650a\")?,\n                state: Some(\"pg\".to_string()),\n                street_1: Some(\"jhslifrl\".to_string()),\n                street_2: Some(\"\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"wgdpe\".to_string()),\n                zip: Some(\"ststpyjc\".to_string()),\n            }),\n            name: Some(\"vu\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 534-000-3344\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n\n```"]
