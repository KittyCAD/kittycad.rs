...
impl Payments {
    ...
    #[doc = "Update payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It updates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_update_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .update_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"jrldw\".to_string()),\n                country: Some(\"kccirov\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"89e3a63c-0e98-4b4a-b219-e967de9b154f\")?,\n                state: Some(\"thvtfxegc\".to_string()),\n                street_1: Some(\"rsvpyy\".to_string()),\n                street_2: Some(\"vv\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"uygsgu\".to_string()),\n                zip: Some(\"ar\".to_string()),\n            }),\n            name: Some(\"y\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 648-657-0288\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    ...
    #[doc = "Create payment info for your user.\n\nThis includes billing address, phone, and name.\nThis endpoint requires authentication by any KittyCAD user. It creates the payment information for the authenticated user.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_payments_create_payment_information_for_user() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let result: kittycad::types::Customer = client\n        .payments()\n        .create_payment_information_for_user(&kittycad::types::BillingInfo {\n            address: Some(kittycad::types::Address {\n                city: Some(\"u\".to_string()),\n                country: Some(\"\".to_string()),\n                created_at: chrono::Utc::now(),\n                id: uuid::Uuid::from_str(\"435c380e-5030-4a13-8845-edd9f51b5b0a\")?,\n                state: Some(\"xcpbkbjg\".to_string()),\n                street_1: Some(\"qyarsi\".to_string()),\n                street_2: Some(\"bgt\".to_string()),\n                updated_at: chrono::Utc::now(),\n                user_id: Some(\"dfvrh\".to_string()),\n                zip: Some(\"njtlfv\".to_string()),\n            }),\n            name: Some(\"jgysgxwq\".to_string()),\n            phone: kittycad::types::phone_number::PhoneNumber::from_str(\"+1 708-402-7562\")?,\n        })\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    ...
    #[doc = "Delete a payment method for your user.\n\nThis endpoint requires authentication by \
             ...
             -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    \
             client\n        .payments()\n        .delete_payment_method_for_user(\"va\")\n        \
             .await?;\n    Ok(())\n}\n```"]
