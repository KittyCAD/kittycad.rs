...
impl Oauth2 {
    ...
    #[doc = "Request a device access token.\n\nThis endpoint should be polled by the client until the user code is verified and the grant is confirmed.\n\n```rust,no_run\nuse std::str::FromStr;\nasync fn example_oauth2_device_access_token() -> anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    client\n        .oauth2()\n        .device_access_token(&kittycad::types::CrateTypesDeviceAccessTokenRequestForm {\n            client_id: uuid::Uuid::from_str(\"3363641c-2d37-448a-9e07-788e3c8041c2\")?,\n            device_code: uuid::Uuid::from_str(\"9a8cb264-71ae-457b-9725-1f7d29f5f6e3\")?,\n            grant_type: kittycad::types::Oauth2GrantType::UrnIetfParamsOauthGrantTypeDeviceCode,\n        })\n        .await?;\n    Ok(())\n}\n```"]
