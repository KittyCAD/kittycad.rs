...
impl Oauth2 {
    ...
    pub async fn device_auth_request(
        &self,
        _body: &crate::types::DeviceAuthRequestForm,
    ) -> Result<()> {
        todo!()
    }
    ...
    pub async fn device_auth_confirm(
        &self,
        _body: &crate::types::DeviceAuthVerifyParams,
    ) -> Result<()> {
        todo!()
    }
    ...
    pub async fn device_access_token(
        &self,
        _body: &crate::types::DeviceAccessTokenRequestForm,
    ) -> Result<()> {
        todo!()
    }
    ...
    pub async fn device_auth_verify(&self, _user_code: String) -> Result<()> {
        todo!()
    }
