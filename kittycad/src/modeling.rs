...
pub struct CommandsWsParams {
    ...
    pub kcl_version: Option<crate::types::KclVersion>,
...
impl Modeling {
    ...
    pub async fn commands_ws<'a>(
        ...
        if let Some(p) = kcl_version {
            query_params.push(("kcl_version", format!("{}", p)));
        }
