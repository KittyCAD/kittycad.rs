...
impl Ml {
    ...
    #[tracing::instrument]
    pub async fn list_ai_prompts<'a>(
        &'a self,
        limit: Option<u32>,
    ...
    #[tracing::instrument]
    #[cfg(not(feature = "js"))]
    pub fn list_ai_prompts_stream<'a>(
        &'a self,
        limit: Option<u32>,
        sort_by: Option<crate::types::CreatedAtSortMode>,
        ...
        self.list_ai_prompts(limit, None, sort_by)
            .map_ok(move |result| {
