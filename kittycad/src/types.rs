...
pub struct FileCenterOfMass {
    #[doc = "The resulting center of mass. This is deprecated and will be removed in a future \
             release. Use `centers_of_mass` instead."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[deprecated]
    pub center_of_mass: Option<Point3D>,
    #[doc = "The center of mass for each mesh in the file. The key of the hash map is the mesh \
             name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub centers_of_mass: Option<std::collections::HashMap<String, Point3D>>,
...
impl tabled::Tabled for FileCenterOfMass {
    ...
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![
            ...
            if let Some(centers_of_mass) = &self.centers_of_mass {
                format!("{:?}", centers_of_mass).into()
            } else {
                String::new().into()
            },
            if let Some(completed_at) = &self.completed_at {
...
pub struct FileDensity {
    ...
    #[doc = "The time and date the API call was created."]
    pub created_at: chrono::DateTime<chrono::Utc>,
    #[doc = "The density for each mesh in the file. The key of the hash map is the mesh name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub densities: Option<std::collections::HashMap<String, f64>>,
    #[doc = "The resulting density. This is deprecated and will be removed in a future release, \
             use `densities` instead."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[deprecated]
...
pub struct FileMass {
    ...
    #[doc = "The unique identifier of the API call.\n\nThis is the same as the API call ID."]
    pub id: uuid::Uuid,
    #[doc = "The resulting mass. This is deprecated and will be removed in a future release, use \
             `masses` instead."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[deprecated]
    pub mass: Option<f64>,
    #[doc = "The mass for each mesh in the file. The key of the hash map is the mesh name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub masses: Option<std::collections::HashMap<String, f64>>,
...
pub struct FileSurfaceArea {
    ...
    #[doc = "The status of the API call."]
    pub status: ApiCallStatus,
    #[doc = "The resulting surface area. This is deprecated and will be removed in a future \
             release. Use `surface_areas` instead."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[deprecated]
    pub surface_area: Option<f64>,
    #[doc = "The surface area for each mesh in the file. The key of the hash map is the mesh name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub surface_areas: Option<std::collections::HashMap<String, f64>>,
    #[doc = "The time and date the API call was last updated."]
    pub updated_at: chrono::DateTime<chrono::Utc>,
    #[doc = "The user ID of the user who created the API call."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl tabled::Tabled for FileSurfaceArea {
    ...
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![
            ...
            if let Some(surface_areas) = &self.surface_areas {
                format!("{:?}", surface_areas).into()
            } else {
                String::new().into()
            },
            format!("{:?}", self.updated_at).into(),
...
pub struct FileVolume {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub user_id: Option<String>,
    #[doc = "The resulting volume. This is deprecated and will be removed in a future release. \
             Use `volumes` instead."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[deprecated]
    pub volume: Option<f64>,
    #[doc = "The volumes for each mesh in the file. The key of the hash map is the mesh name."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub volumes: Option<std::collections::HashMap<String, f64>>,
}
...
pub struct ModelingCmdMovePathPen {
    #[serde(rename = "MovePathPen")]
    pub move_path_pen: MovePathPen,
}

impl std::fmt::Display for ModelingCmdMovePathPen {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdMovePathPen {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.move_path_pen).into()]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["move_path_pen".into()]
    }
}
...
impl tabled::Tabled for ExtendPath {
    ...
    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["path".into(), "segment".into()]
    }
}

#[doc = "Extend a path by adding a new segment which starts at the path's \"pen\". If no \"pen\" \
         location has been set before (via `MovePen`), then the pen is at the origin."]
#[derive(
    serde :: Serialize, serde :: Deserialize, PartialEq, Debug, Clone, schemars :: JsonSchema,
)]
pub struct ModelingCmdExtendPath {
    #[serde(rename = "ExtendPath")]
    pub extend_path: ExtendPath,
}

impl std::fmt::Display for ModelingCmdExtendPath {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdExtendPath {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.extend_path).into()]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["extend_path".into()]
    }
}
...
pub struct ModelingCmdExtrude {
    #[doc = "Command for extruding a solid."]
    #[serde(rename = "Extrude")]
    pub extrude: Extrude,
}

impl std::fmt::Display for ModelingCmdExtrude {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdExtrude {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.extrude).into()]
    }
...
pub struct ModelingCmdCameraDragStart {
    #[serde(rename = "CameraDragStart")]
    pub camera_drag_start: CameraDragStart,
}

impl std::fmt::Display for ModelingCmdCameraDragStart {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdCameraDragStart {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.camera_drag_start).into()]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["camera_drag_start".into()]
    }
}
...
pub struct ModelingCmdCameraDragMove {
    #[serde(rename = "CameraDragMove")]
    pub camera_drag_move: CameraDragMove,
}

impl std::fmt::Display for ModelingCmdCameraDragMove {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdCameraDragMove {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.camera_drag_move).into()]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["camera_drag_move".into()]
    }
}
...
pub struct ModelingCmdCameraDragEnd {
    #[serde(rename = "CameraDragEnd")]
    pub camera_drag_end: CameraDragEnd,
}

impl std::fmt::Display for ModelingCmdCameraDragEnd {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdCameraDragEnd {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.camera_drag_end).into()]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["camera_drag_end".into()]
    }
}
...
impl tabled::Tabled for DefaultCameraLookAt {
    ...
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![
            ...
            format!("{:?}", self.up).into(),
            format!("{:?}", self.vantage).into(),
        ]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["center".into(), "up".into(), "vantage".into()]
    }
}
...
pub struct ModelingCmdDefaultCameraLookAt {
    #[serde(rename = "DefaultCameraLookAt")]
    pub default_camera_look_at: DefaultCameraLookAt,
}

impl std::fmt::Display for ModelingCmdDefaultCameraLookAt {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdDefaultCameraLookAt {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.default_camera_look_at).into()]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["default_camera_look_at".into()]
    }
}
...
pub struct DefaultCameraEnableSketchMode {
    ...
    pub origin: Point3D,
    #[doc = "Should the camera use orthographic projection? In other words, should an object's \
             size in the rendered image stay constant regardless of its distance from the camera."]
    pub ortho: bool,
...
impl std::fmt::Display for DefaultCameraEnableSketchMode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for DefaultCameraEnableSketchMode {
    const LENGTH: usize = 5;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![
            format!("{:?}", self.distance_to_plane).into(),
...
pub struct ModelingCmdDefaultCameraEnableSketchMode {
    #[serde(rename = "DefaultCameraEnableSketchMode")]
    pub default_camera_enable_sketch_mode: DefaultCameraEnableSketchMode,
}

impl std::fmt::Display for ModelingCmdDefaultCameraEnableSketchMode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdDefaultCameraEnableSketchMode {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.default_camera_enable_sketch_mode).into()]
    }

    fn headers() -> Vec<std::borrow::Cow<'static, str>> {
        vec!["default_camera_enable_sketch_mode".into()]
    }
}
...
#[cfg_attr(feature = "tabled", derive(tabled::Tabled))]
#[derive(Default)]
pub enum ModelingCmdDefaultCameraDisableSketchMode {
    #[default]
...
pub struct ModelingCmdExport {
    #[serde(rename = "Export")]
    pub export: Export,
}

impl std::fmt::Display for ModelingCmdExport {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
#[cfg(feature = "tabled")]
impl tabled::Tabled for ModelingCmdExport {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![format!("{:?}", self.export).into()]
    }
...
pub enum ModelingCmd {
    ModelingCmdStartPath(ModelingCmdStartPath),
    ...
    ModelingCmdDefaultCameraLookAt(ModelingCmdDefaultCameraLookAt),
    ModelingCmdDefaultCameraEnableSketchMode(ModelingCmdDefaultCameraEnableSketchMode),
    ModelingCmdDefaultCameraDisableSketchMode(ModelingCmdDefaultCameraDisableSketchMode),
    ModelingCmdExport(ModelingCmdExport),
}
