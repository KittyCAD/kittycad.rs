...
pub struct OrgDatasetFileConversionSummary {
    ...
    #[doc = "Numeric index for `phase` so clients do not need to hardcode enum \
             ordering.\n\nMapping: - `0`: `queued` - `1`: `snapshot_original` - `2`: \
             `convert_raw_kcl` - `3`: `snapshot_raw_kcl` - `4`: `salon` - `5`: \
             `snapshot_salon_kcl` - `6`: `completed`"]
    pub phase_index: u8,
