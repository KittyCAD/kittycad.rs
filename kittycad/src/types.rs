...
impl std::fmt::Display for DrawCircle {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
impl tabled::Tabled for DrawCircle {
    const LENGTH: usize = 2;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.center), format!("{:?}", self.radius)]
    }

    fn headers() -> Vec<String> {
        vec!["center".to_string(), "radius".to_string()]
    }
}
...
pub struct DrawingCmdOneOf {
    #[serde(rename = "DrawCircle")]
    pub draw_circle: DrawCircle,
}

impl std::fmt::Display for DrawingCmdOneOf {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
impl tabled::Tabled for DrawingCmdOneOf {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.draw_circle)]
    }

    fn headers() -> Vec<String> {
        vec!["draw_circle".to_string()]
    }
}
...
impl tabled::Tabled for Extrude {
    const LENGTH: usize = 2;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.distance), format!("{:?}", self.sketch)]
    }

    fn headers() -> Vec<String> {
        vec!["distance".to_string(), "sketch".to_string()]
    }
}

#[doc = "Extrude a sketch."]
#[derive(
    serde :: Serialize, serde :: Deserialize, PartialEq, Debug, Clone, schemars :: JsonSchema,
)]
pub struct DrawingCmdOneOfOneOf {
    #[serde(rename = "Extrude")]
    pub extrude: Extrude,
}

impl std::fmt::Display for DrawingCmdOneOfOneOf {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
impl tabled::Tabled for DrawingCmdOneOfOneOf {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.extrude)]
    }

    fn headers() -> Vec<String> {
        vec!["extrude".to_string()]
    }
}
...
pub enum DrawingCmd {
    DrawingCmdOneOf(DrawingCmdOneOf),
    DrawingCmdOneOfOneOf(DrawingCmdOneOfOneOf),
}
...
#[doc = "Each successful command has some result. Unfortunately this isn't strongly typed, because \
         the result depends on the command. This means the OpenAPI schema for this won't be very \
         useful."]
#[derive(
    serde :: Serialize, serde :: Deserialize, PartialEq, Debug, Clone, schemars :: JsonSchema,
)]
pub struct DrawingOutcomeOneOf {
    #[serde(rename = "Success")]
    pub success: serde_json::Value,
}

impl std::fmt::Display for DrawingOutcomeOneOf {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
impl tabled::Tabled for DrawingOutcomeOneOf {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.success)]
    }
...
#[doc = "It failed. Why? See 'struct Error' above."]
#[derive(
    serde :: Serialize, serde :: Deserialize, PartialEq, Debug, Clone, schemars :: JsonSchema,
)]
pub struct DrawingOutcomeOneOfOneOf {
    #[doc = "Why a command submitted to the Drawing API failed."]
    #[serde(rename = "Error")]
    pub error: DrawingError,
}

impl std::fmt::Display for DrawingOutcomeOneOfOneOf {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
impl tabled::Tabled for DrawingOutcomeOneOfOneOf {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.error)]
    }
...
impl tabled::Tabled for Cancelled {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.what_failed)]
    }

    fn headers() -> Vec<String> {
        vec!["what_failed".to_string()]
    }
}

#[doc = "Cancelled because it required the output of a previous command, which failed."]
#[derive(
    serde :: Serialize, serde :: Deserialize, PartialEq, Debug, Clone, schemars :: JsonSchema,
)]
pub struct DrawingOutcomeOneOfOneOfOneOf {
    #[serde(rename = "Cancelled")]
    pub cancelled: Cancelled,
}

impl std::fmt::Display for DrawingOutcomeOneOfOneOfOneOf {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> Result<(), std::fmt::Error> {
        write!(
            f,
            "{}",
...
impl tabled::Tabled for DrawingOutcomeOneOfOneOfOneOf {
    const LENGTH: usize = 1;
    fn fields(&self) -> Vec<String> {
        vec![format!("{:?}", self.cancelled)]
    }
...
pub enum DrawingOutcome {
    DrawingOutcomeOneOf(DrawingOutcomeOneOf),
    DrawingOutcomeOneOfOneOf(DrawingOutcomeOneOfOneOf),
    DrawingOutcomeOneOfOneOfOneOf(DrawingOutcomeOneOfOneOfOneOf),
}
