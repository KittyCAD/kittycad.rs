...
pub struct CrmData {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cad_user_count: Option<String>,
    #[doc = "The user type."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl tabled::Tabled for CrmData {
    ...
    fn fields(&self) -> Vec<std::borrow::Cow<'static, str>> {
        vec![
            ...
            if let Some(cad_user_count) = &self.cad_user_count {
                format!("{:?}", cad_user_count).into()
            } else {
                String::new().into()
            },
...
pub enum Environment {
    ...
    #[display("DEVELOPMENT")]
    Development,
    #[doc = "The preview environment. This is deployed to api.dev.zoo.dev."]
