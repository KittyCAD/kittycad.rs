...
pub enum UnitArea {
    ...
    #[display("acres")]
    Acres,
    #[doc = "Hectares <https://en.wikipedia.org/wiki/Hectare>"]
    #[serde(rename = "hectares")]
    #[display("hectares")]
    Hectares,
    #[doc = "Square centimetres <https://en.wikipedia.org/wiki/Square_centimetre>"]
    #[serde(rename = "square_centimetres")]
    #[display("square_centimetres")]
    SquareCentimetres,
    #[doc = "Square decimetres <https://en.wikipedia.org/wiki/Square_decimetre>"]
    #[serde(rename = "square_decimetres")]
    #[display("square_decimetres")]
    SquareDecimetres,
    #[doc = "Square feet <https://en.wikipedia.org/wiki/Square_foot>"]
    #[serde(rename = "square_feet")]
    #[display("square_feet")]
    SquareFeet,
    #[doc = "Square hectometres <https://en.wikipedia.org/wiki/Square_hectometre>"]
    #[serde(rename = "square_hectometres")]
    #[display("square_hectometres")]
    SquareHectometres,
    #[doc = "Square inches <https://en.wikipedia.org/wiki/Square_inch>"]
    #[serde(rename = "square_inches")]
    #[display("square_inches")]
    SquareInches,
    #[doc = "Square kilometres <https://en.wikipedia.org/wiki/Square_kilometre>"]
    #[serde(rename = "square_kilometres")]
    #[display("square_kilometres")]
    SquareKilometres,
    #[doc = "Square metres <https://en.wikipedia.org/wiki/Square_metre>"]
    #[serde(rename = "square_metres")]
    #[display("square_metres")]
    SquareMetres,
    #[doc = "Square micrometres <https://en.wikipedia.org/wiki/Square_micrometre>"]
    #[serde(rename = "square_micrometres")]
    #[display("square_micrometres")]
    SquareMicrometres,
    #[doc = "Square miles <https://en.wikipedia.org/wiki/Square_mile>"]
    #[serde(rename = "square_miles")]
    #[display("square_miles")]
    SquareMiles,
    #[doc = "Square millimetres <https://en.wikipedia.org/wiki/Square_millimetre>"]
    #[serde(rename = "square_millimetres")]
    #[display("square_millimetres")]
    SquareMillimetres,
    #[doc = "Square nanometres <https://en.wikipedia.org/wiki/Square_nanometre>"]
    #[serde(rename = "square_nanometres")]
    #[display("square_nanometres")]
    SquareNanometres,
    #[doc = "Square yards <https://en.wikipedia.org/wiki/Square_mile>"]
    #[serde(rename = "square_yards")]
    #[display("square_yards")]
    SquareYards,
}
...
pub enum UnitLength {
    ...
    #[display("centimetres")]
    Centimetres,
    #[doc = "Decimetres <https://en.wikipedia.org/wiki/Decimetre>"]
    #[serde(rename = "decimetres")]
    #[display("decimetres")]
    Decimetres,
    ...
    #[display("feet")]
    Feet,
    #[doc = "Furlongs <https://en.wikipedia.org/wiki/Furlong>"]
    #[serde(rename = "furlongs")]
    #[display("furlongs")]
    Furlongs,
    #[doc = "Hectometres <https://en.wikipedia.org/wiki/Hectometre>"]
    #[serde(rename = "hectometres")]
    #[display("hectometres")]
    Hectometres,
    ...
    #[display("inches")]
    Inches,
    #[doc = "Kilometres <https://en.wikipedia.org/wiki/Kilometre>"]
    #[serde(rename = "kilometres")]
    #[display("kilometres")]
    Kilometres,
    ...
    #[display("metres")]
    Metres,
    #[doc = "Micrometres <https://en.wikipedia.org/wiki/Micrometre>"]
    #[serde(rename = "micrometres")]
    #[display("micrometres")]
    Micrometres,
    #[doc = "Miles <https://en.wikipedia.org/wiki/Mile>"]
    #[serde(rename = "miles")]
    #[display("miles")]
    Miles,
    #[doc = "Millimetres <https://en.wikipedia.org/wiki/Millimetre>"]
    #[serde(rename = "millimetres")]
    #[display("millimetres")]
    Millimetres,
    #[doc = "Nanometres <https://en.wikipedia.org/wiki/Nanometre>"]
    #[serde(rename = "nanometres")]
    #[display("nanometres")]
    Nanometres,
...
pub enum UnitMass {
    ...
    #[display("carats")]
    Carats,
    #[doc = "Grains <https://en.wikipedia.org/wiki/Grain_(unit)>"]
    #[serde(rename = "grains")]
    #[display("grains")]
    Grains,
    ...
    #[display("kilograms")]
    Kilograms,
    #[doc = "Long tons <https://en.wikipedia.org/wiki/Long_ton>"]
    #[serde(rename = "long_tons")]
    #[display("long_tons")]
    LongTons,
    #[doc = "Metric tons <https://en.wikipedia.org/wiki/Tonne>"]
    #[serde(rename = "metric_tons")]
    #[display("metric_tons")]
    MetricTons,
    #[doc = "Micrograms <https://en.wikipedia.org/wiki/Microgram>"]
    #[serde(rename = "micrograms")]
    #[display("micrograms")]
    Micrograms,
    #[doc = "Milligrams <https://en.wikipedia.org/wiki/Milligram>"]
    #[serde(rename = "milligrams")]
    #[display("milligrams")]
    Milligrams,
    #[doc = "Ounces <https://en.wikipedia.org/wiki/Ounce>"]
    #[serde(rename = "ounces")]
    #[display("ounces")]
    Ounces,
    #[doc = "Pennyweights <https://en.wikipedia.org/wiki/Pennyweight>"]
    #[serde(rename = "pennyweights")]
    #[display("pennyweights")]
    Pennyweights,
    #[doc = "Pounds <https://en.wikipedia.org/wiki/Pound_(mass)>"]
    #[serde(rename = "pounds")]
    #[display("pounds")]
    Pounds,
    #[doc = "Short tons <https://en.wikipedia.org/wiki/Short_ton>"]
    #[serde(rename = "short_tons")]
    #[display("short_tons")]
    ShortTons,
    #[doc = "Stones <https://en.wikipedia.org/wiki/Stone_(unit)>"]
    #[serde(rename = "stones")]
    #[display("stones")]
    Stones,
    #[doc = "Troy ounces <https://en.wikipedia.org/wiki/Troy_ounce>"]
    #[serde(rename = "troy_ounces")]
    #[display("troy_ounces")]
    TroyOunces,
    #[doc = "Troy pounds <https://en.wikipedia.org/wiki/Troy_pound>"]
    #[serde(rename = "troy_pounds")]
    #[display("troy_pounds")]
    TroyPounds,
}
...
pub enum UnitVolume {
    ...
    #[display("cubic_inches")]
    CubicInches,
    #[doc = "Cubic metres (m³) <https://en.wikipedia.org/wiki/Cubic_metre>"]
    #[serde(rename = "cubic_metres")]
    #[display("cubic_metres")]
    CubicMetres,
    #[doc = "Cubic yards (yd³) <https://en.wikipedia.org/wiki/Cubic_yard>"]
    #[serde(rename = "cubic_yards")]
    #[display("cubic_yards")]
    CubicYards,
    #[doc = "Cups <https://en.wikipedia.org/wiki/Cup_(unit)>"]
    #[serde(rename = "cups")]
    #[display("cups")]
    Cups,
    #[doc = "Drams <https://en.wikipedia.org/wiki/Fluid_dram>"]
    #[serde(rename = "drams")]
    #[display("drams")]
    Drams,
    #[doc = "Drops <https://en.wikipedia.org/wiki/Minim_(unit)>"]
    #[serde(rename = "drops")]
    #[display("drops")]
    Drops,
    #[doc = "US Fluid Ounces (fl oz) <https://en.wikipedia.org/wiki/Fluid_ounce>"]
    #[serde(rename = "fluid_ounces")]
    #[display("fluid_ounces")]
    FluidOunces,
    #[doc = "UK Fluid Ounces (fl oz) <https://en.wikipedia.org/wiki/Fluid_ounce>"]
    #[serde(rename = "fluid_ounces_uk")]
    #[display("fluid_ounces_uk")]
    FluidOuncesUk,
    #[doc = "US Gallons (gal US) <https://en.wikipedia.org/wiki/Gallon>"]
    #[serde(rename = "gallons")]
    #[display("gallons")]
    Gallons,
    #[doc = "UK/Imperial Gallons (gal) <https://en.wikipedia.org/wiki/Gallon>"]
    #[serde(rename = "gallons_uk")]
    #[display("gallons_uk")]
    GallonsUk,
    ...
    #[display("millilitres")]
    Millilitres,
    #[doc = "Pints <https://en.wikipedia.org/wiki/Pint>"]
    #[serde(rename = "pints")]
    #[display("pints")]
    Pints,
    #[doc = "Pints in the United Kingdom (UK) <https://en.wikipedia.org/wiki/Pint>"]
    #[serde(rename = "pints_uk")]
    #[display("pints_uk")]
    PintsUk,
    #[doc = "Quarts <https://en.wikipedia.org/wiki/Quart>"]
    #[serde(rename = "quarts")]
    #[display("quarts")]
    Quarts,
    #[doc = "Tablespoons (tbsp) <https://en.wikipedia.org/wiki/Tablespoon>"]
    #[serde(rename = "tablespoons")]
    #[display("tablespoons")]
    Tablespoons,
    #[doc = "Teaspoons (tsp) <https://en.wikipedia.org/wiki/Teaspoon>"]
    #[serde(rename = "teaspoons")]
    #[display("teaspoons")]
    Teaspoons,
}
