...
impl Unit {
    ...
    #[doc = "Convert density units.\n\nConvert a density unit value to another density unit value. \
             This is a nice endpoint to use for helper functions.\n\n**Parameters:**\n\n- \
             `output_format: crate::types::UnitDensityFormat`: The output format of the unit. \
             (required)\n- `src_format: crate::types::UnitDensityFormat`: The source format of the \
             unit. (required)\n- `value: f64`: The initial value. \
             (required)\n\n```rust,no_run\nasync fn example_unit_get_density_conversion() -> \
             anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let \
             result: kittycad::types::UnitDensityConversion = client\n        .unit()\n        \
             .get_density_conversion(\n            \
             kittycad::types::UnitDensityFormat::KilogramsPerLiter,\n            \
             kittycad::types::UnitDensityFormat::KilogramsPerCubicMeter,\n            3.14 as \
             f64,\n        )\n        .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
