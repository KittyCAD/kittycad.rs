...
impl Unit {
    ...
    #[doc = "Convert angle units.\n\nConvert an angle unit value to another angle unit value. This \
             ...
             `output_format: crate::types::UnitAngleFormat`: The output format of the unit. \
             (required)\n- `src_format: crate::types::UnitAngleFormat`: The source format of the \
             unit. (required)\n- `value: f64`: The initial value. \
             (required)\n\n```rust,no_run\nasync fn example_unit_get_angle_conversion() -> \
             anyhow::Result<()> {\n    let client = kittycad::Client::new_from_env();\n    let \
             result: kittycad::types::UnitAngleConversion = client\n        .unit()\n        \
    ...
    #[doc = "Convert length units.\n\nConvert a length unit value to another length unit value. \
             ...
             kittycad::types::UnitLengthFormat::Mil,\n            3.14 as f64,\n        )\n        \
             .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
