...
impl Unit {
    ...
    #[doc = "Convert metric cubed units.\n\nConvert a metric cubed unit value to another metric \
             ...
             kittycad::types::UnitMetricPower::Giga,\n            3.14 as f64,\n        )\n        \
             .await?;\n    println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
