...
impl File {
    ...
    #[doc = "Convert 2D Vector file.\n\nConvert a 2D Vector file from one format to another. If \
             the file being converted is larger than 25MB, it will be performed \
             ...
             `output_format: crate::types::File2DVectorExportFormat`: The format the file should \
             be converted to. (required)\n- `src_format: crate::types::File2DVectorImportFormat`: \
             The format of the file to convert. (required)\n\n```rust,no_run\nasync fn \
             example_file_create_2d_vector_conversion() -> anyhow::Result<()> {\n    let client = \
             ...
             println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    pub async fn create_2d_vector_conversion<'a>(
        &'a self,
        output_format: crate::types::File2DVectorExportFormat,
        src_format: crate::types::File2DVectorImportFormat,
        body: &bytes::Bytes,
    ) -> Result<crate::types::File2DVectorConversion, crate::types::error::Error> {
    ...
    #[doc = "Convert 3D file.\n\nConvert a 3D file from one format to another. If the file being \
             ...
             crate::types::File3DExportFormat`: The format the file should be converted to. \
             (required)\n- `src_format: crate::types::File3DImportFormat`: The format of the file \
             to convert. (required)\n\n```rust,no_run\nasync fn \
             ...
             println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    #[tracing::instrument]
    pub async fn create_3d_conversion<'a>(
        &'a self,
        output_format: crate::types::File3DExportFormat,
        src_format: crate::types::File3DImportFormat,
        body: &bytes::Bytes,
    ) -> Result<crate::types::File3DConversion, crate::types::error::Error> {
        let mut req = self.client.client.request(
            http::Method::POST,
            &format!(
                "{}/{}",
    ...
    #[doc = "Get CAD file center of mass.\n\nGet the center of mass of an object in a CAD file. If \
             ...
             the `center_of_mass_with_uniform_density` endpoint; except, this has a redundant \
             `material_density value`. Kept for legacy in this version.\nIf the operation is \
             ...
             crate::types::File3DImportFormat`: The format of the file. \
    ...
    #[tracing::instrument]
    pub async fn create_center_of_mass_with_uniform_density<'a>(
        &'a self,
        src_format: crate::types::File3DImportFormat,
        body: &bytes::Bytes,
    ) -> Result<crate::types::FileCenterOfMassWithUniformDensity, crate::types::error::Error> {
        let mut req = self.client.client.request(
            http::Method::POST,
            &format!(
                "{}/{}",
                self.client.base_url, "file/center-of-mass-with-uniform-density"
            ),
        );
        req = req.bearer_auth(&self.client.token);
