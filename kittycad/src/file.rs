...
impl File {
    ...
    #[doc = "Execute a KittyCAD program in a specific language.\n\n```rust,no_run\nasync fn \
             ...
             &bytes::Bytes::from(\"IWu1VkqMWOEml-UC\"),\n        )\n        .await?;\n    \
             println!(\"{:?}\", result);\n    Ok(())\n}\n```"]
    ...
    #[doc = "Get a file conversion for your user.\n\nGet the status and output of an async file \
             ...
             client.file().get_conversion_for_user(\"acynb\").await?;\n    println!(\"{:?}\", \
             result);\n    Ok(())\n}\n```"]
