...
impl ApiCalls {
    ...
    pub async fn get_api_call_metrics(
        &self,
        _group_by: crate::types::ApiCallQueryGroupBy,
    ...
    pub async fn get_api_call(&self, _id: String) -> Result<crate::types::ApiCallWithPrice> {
        todo!()
    }
    ...
    pub async fn list_async_operations(
        ...
        _page_token: Option<String>,
        _sort_by: Option<crate::types::CreatedAtSortMode>,
        _status: Option<crate::types::ApiCallStatus>,
