...
pub async fn get_async_operation(&self, id: String) -> Result<crate::types::AsyncApiCallOutput> {
    todo!()
}
...
pub async fn get_api_call_for_user(&self, id: String) -> Result<crate::types::ApiCallWithPrice> {
    todo!()
}
