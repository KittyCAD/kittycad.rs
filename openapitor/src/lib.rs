...
reqwest = {{ version = "0.13.2", default-features = false, features = ["json", "multipart", "form", "query"], optional = true }}
reqwest-middleware = {{ version = "0.5.1", optional = true, features = ["json", "multipart", "form", "query", "http2"] }}
...
retry = ["dep:reqwest-retry", "dep:reqwest-middleware", "dep:reqwest-tracing"]
